...
- Own and evolve metered billing system that serves millions of GitHub users, driving architectural decisions that balance reliability, scale, and developer velocity.
- Work across the stack, from backend services to APIs to frontend experiences.
...
- Hands-on experience building and operating Go services at scale in high-traffic production environments.
- Experience with JavaScript and frontend frameworks like React.
- Experience building or operating metered billing, budgeting controls, invoicing, or similarly high-stakes transactional systems.
